...
ENV SOURCE_URL=https://github.com/esnet/iperf/releases/download/3.19/iperf-3.19.tar.gz \
    SOURCE_SHA256SUM_URL=https://github.com/esnet/iperf/releases/download/3.19/iperf-3.19.tar.gz.sha256
